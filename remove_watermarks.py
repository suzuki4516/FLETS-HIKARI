...
project_path = r'c:\Users\Victu\OneDrive\Desktop\Ai関連\hp_development\projects\hp\Usen関連\FLETS-HIKARI'
...
for i, jpg_file in enumerate(jpg_files):
    ...
    # Remove top right logo (USEN NETWORKS / USEN-NEXT GROUP)
    # Cover area from about 85% width to right edge, top 80 pixels
    top_right_box = (int(width * 0.85), 0, width, 80)
    draw.rectangle(top_right_box, fill='white')

    # Remove bottom right page number
    # Cover area from 95% width to right edge, bottom 60 pixels
